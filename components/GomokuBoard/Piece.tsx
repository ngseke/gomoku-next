...
export function Piece ({ color, className }: {
  color: 'black' | 'white'
  className?: string
}) {
  return (
    <div
      className={cn(
        'inline-block aspect-square size-10/12 rounded-full border border-transparent bg-gradient-to-tr from-neutral-200 to-neutral-200',
        {
